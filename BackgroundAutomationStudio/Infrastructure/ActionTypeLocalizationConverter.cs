...
public sealed class ActionTypeLocalizationConverter : IValueConverter
{
    ...
    {
        "Click" => LocalizationService.Get("Click"), "Right click" => LocalizationService.Get("RightClick"), "Double click" => LocalizationService.Get("DoubleClick"), "Drag" => LocalizationService.Get("Drag"),
