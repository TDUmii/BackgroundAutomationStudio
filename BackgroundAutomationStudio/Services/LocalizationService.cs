...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, (string En, string Vi)> Text = new()
    {
        ...
        ["EditAction"] = ("Edit action", "Sửa thao tác"), ["DuplicateAction"] = ("Duplicate action", "Nhân bản thao tác"), ["DeleteAction"] = ("Delete action", "Xóa thao tác"), ["Undo"] = ("Undo", "Hoàn tác"), ["Redo"] = ("Redo", "Làm lại"), ["MoveUp"] = ("Move up", "Di chuyển lên"), ["MoveDown"] = ("Move down", "Di chuyển xuống"),
        ["VersionLabel"] = ("Version 1.4 - Strict Focus & Semantic Playback", "Phiên bản 1.4 - Giữ focus & Phát ngữ nghĩa"),
        ...
        ["RepeatMode"] = ("RUN SCHEDULE", "LỊCH CHẠY"), ["RepeatCount"] = ("REPEAT COUNT", "SỐ LẦN LẶP"), ["RepeatHelp"] = ("Choose a count, run forever, run for a duration, or stop at a clock time.", "Chọn số lần, chạy vô tận, chạy theo thời lượng hoặc dừng tại một giờ cụ thể."),
        ["RepeatCountMode"] = ("Repeat a set number", "Lặp theo số lần"), ["RepeatInfiniteMode"] = ("Run until stopped", "Chạy vô tận đến khi dừng"), ["RepeatDurationMode"] = ("Run for a duration", "Chạy trong một khoảng thời gian"), ["RepeatUntilTimeMode"] = ("Stop at a clock time", "Dừng vào giờ đã đặt"),
        ["DurationMinutes"] = ("DURATION (MINUTES)", "THỜI LƯỢNG (PHÚT)"), ["StopAtTime"] = ("STOP AT (HH:mm)", "DỪNG LÚC (HH:mm)"), ["InfiniteHelp"] = ("Runs continuously until you press Stop or the global hotkey.", "Chạy liên tục đến khi bạn nhấn Dừng hoặc phím tắt toàn cục."),
        ...
        ["NoActions"] = ("No actions yet", "Chưa có thao tác"), ["NoActionsHelp"] = ("Select a target, then Record - or use Add action to build the workflow manually.", "Chọn cửa sổ đích, sau đó Ghi - hoặc dùng Thêm thao tác để tạo thủ công."), ["Edit"] = ("Edit", "Sửa"), ["Duplicate"] = ("Duplicate", "Nhân bản"), ["Delete"] = ("Delete", "Xóa"), ["ClearAll"] = ("Clear all", "Xóa tất cả"), ["Current"] = ("CURRENT", "HIỆN TẠI"),
        ...
        ["BackgroundMode"] = ("Focus-safe background playback - keep using other apps", "Phát nền không chiếm focus - tiếp tục dùng ứng dụng khác"),
        ...
        ["Compatibility"] = ("Strict mode preserves foreground focus and IME composition for supported semantic or Win32 targets. Fully hidden, elevated, raw-input, canvas, game, or anti-cheat targets may still reject background automation.", "Chế độ nghiêm ngặt giữ nguyên focus và tổ hợp bộ gõ IME cho đích hỗ trợ lệnh ngữ nghĩa hoặc Win32. Cửa sổ bị ẩn hoàn toàn, chạy quyền cao, raw-input, canvas, game hoặc anti-cheat vẫn có thể từ chối tự động hóa nền."),
        ...
        ["AutomaticMode"] = ("Strict background (recommended)", "Nền nghiêm ngặt (khuyên dùng)"), ["AutomaticModeHelp"] = ("Use focus-safe semantic commands, then Win32 messages. Never invoke focus-taking UI Automation.", "Dùng lệnh ngữ nghĩa giữ focus, sau đó dùng thông điệp Win32. Không gọi UI Automation có thể cướp focus."),
        ["UiAutomationMode"] = ("Modern controls (may take focus)", "Điều khiển hiện đại (có thể lấy focus)"), ["UiAutomationModeHelp"] = ("Explicit compatibility mode for unsupported modern controls. The target may interrupt typing or IME composition.", "Chế độ tương thích chủ động cho điều khiển hiện đại chưa hỗ trợ. Cửa sổ đích có thể làm gián đoạn gõ hoặc bộ gõ IME."),
