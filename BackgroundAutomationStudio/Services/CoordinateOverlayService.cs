...
public sealed class CoordinateOverlayService : IDisposable
{
    ...
    private readonly DispatcherTimer _timer = new(DispatcherPriority.Background) { Interval = TimeSpan.FromMilliseconds(120) };
    ...
    private void RefreshPosition()
    {
        ...
        _window.UpdateOverlay(_actions, client.Width, client.Height, _showGrid, _markerColor, _markerShape);
